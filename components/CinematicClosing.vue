      ...
      <main class="closing-v56__main">
        ...
        <div class="closing-v56__identity">
          ...
          <div class="closing-v56__identity-copy">
            ...
            <small>github.com/ansonTGN · linkedin.com/in/angelurbina</small>
          </div>
        </div>
      </main>

      <aside class="closing-v56__card">
        <div class="closing-v56__label">PERFIL PROFESIONAL</div>
        <img src="/angel-urbina-profile-qr.png" alt="QR al perfil profesional de Angel A. Urbina" class="closing-v56__qr">
        <strong>Continuemos la conversación</strong>
        <a href="https://angelurbinacv.netlify.app/" target="_blank" rel="noopener noreferrer">angelurbinacv.netlify.app ↗</a>
      </aside>
    </div>
  </section>
</template>
...
<style scoped>
.closing-v56{position:absolute!important;inset:0!important;width:100%!important;height:100%!important;overflow:hidden!important;box-sizing:border-box!important;background:#02060d!important;color:#fff!important;font-family:system-ui,-apple-system,"Segoe UI",sans-serif!important}
.closing-v56__veil{position:absolute!important;z-index:1!important;inset:0!important;background:linear-gradient(90deg,rgba(1,5,12,.88) 0%,rgba(2,7,15,.78) 50%,rgba(2,8,17,.42) 72%,rgba(2,7,14,.46) 100%),linear-gradient(0deg,rgba(1,5,12,.66),transparent 54%,rgba(1,5,12,.14))!important}
.closing-v56__grid{position:absolute!important;z-index:2!important;inset:0!important;opacity:.075!important;background-image:linear-gradient(rgba(255,255,255,.08) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.08) 1px,transparent 1px)!important;background-size:52px 52px!important;pointer-events:none!important}
.closing-v56__shell{position:absolute!important;z-index:3!important;inset:0!important;display:grid!important;grid-template-columns:minmax(0,1fr) 242px!important;align-items:center!important;gap:38px!important;padding:48px 50px!important;box-sizing:border-box!important}
...
.closing-v56__card{width:242px!important;box-sizing:border-box!important;padding:20px 18px 18px!important;border:1px solid rgba(213,241,255,.25)!important;border-radius:26px!important;background:linear-gradient(180deg,rgba(18,37,63,.88),rgba(5,13,27,.92))!important;box-shadow:0 28px 80px rgba(0,0,0,.48),inset 0 1px rgba(255,255,255,.07)!important;text-align:center!important;backdrop-filter:blur(14px)!important}
